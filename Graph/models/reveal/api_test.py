...
if __name__ == '__main__':
    ...
    ds = f'/data1/x/CLVD/storage/cache/ggnn_output/{args.dataset}/ggnn_output.bin'
    ...
    ggnn_output = torch.load(f'/data1/x/CLVD/storage/cache/ggnn_output/{args.dataset}/ggnn_output.bin')
    features = []
    targets = []
