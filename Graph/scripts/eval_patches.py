...
from utils.utils import debug, get_run_id, processed_dir, get_metrics_logits, cache_dir, set_seed, result_dir, get_dir, dfmp, \
...
def main():
    ...
    if args.model == 'ivdetect':
        ...
        # '''
        # DATASET='bigvul'
        # mkdir /data1/CLVD/storage/results/codebert/$DATASET
