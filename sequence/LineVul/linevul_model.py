...
class Model(RobertaForSequenceClassification):
    ...
    def forward(self, input_embed=None, labels=None, output_attentions=False, input_ids=None, output_tSNE_embedding = False):
        if output_attentions:
            ...
            tSNE_embedding = last_hidden_state[:,0,:]
            ...
            if labels is not None:
                ...
                if output_tSNE_embedding:
                    return prob, attentions, tSNE_embedding
                else:
